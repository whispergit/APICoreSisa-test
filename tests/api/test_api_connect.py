...
def test_post_connect_users_login(s: requests.Session):
    route = '/APIConnect/UserLogin'
...
def test_post_connect_students_login(s: requests.Session):
    route = '/APIConnect/StudentLogin'
